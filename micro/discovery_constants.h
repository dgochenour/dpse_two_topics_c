...
// contants for the Micro-based subscribing application (example_subscriber_1.exe) 
static const char *k_PARTICIPANT02_NAME          = "subscriber_1";
static const int k_OBJ_ID_PARTICIPANT02_DR01     = 300;

// contants for the Professional-based subscribing application (example_subscriber_2.exe)
